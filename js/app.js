...
// ============================================================================
import { SECTIONS, FLAGSHIP } from "./data.js?v=24";
import { openScene } from "./scene3d.js?v=24";
import { buildAnatomyViewer } from "./anatomy3d.js?v=24";
import { getThumbnailURL, createLiveViewer } from "./thumbnail.js?v=24";
